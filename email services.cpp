...
char message[800],subject[60],sender[20],receiver[20]; public:
...
system("cls"); remove("messag.dat"); char str[100];
...
system("cls"); remove("message.dat"); int ch;
g:
...
break; case 2:signup();
break; case 3:break;
default:cout<<"enter the right choice"; goto g;
}
...
char pass[20],c=' '; while(c!=char(13))
{

c=getch(); if(c!=char(13))
{
...
char as[20],h=' '; while(h!=char(13))
{

h=getch(); if(h!=char(13))
{
...
char pass[20],ch=' '; while(ch!=char(13))
{

ch=getch(); if(ch!=char(13))
{
...
case 4:outbox();break; case 3:password_change();
break;
...
ifstream fi("messag.dat",ios::binary); message m; while(fi.read((char*)&m,sizeof(m)))
{
